  ...
  return (
    <PageTransition>
      <section className="page-hero">
        ...
        <h1>Transparent campaign cards that turn support into measurable progress.</h1>
        <p>Filter by category, review raised amounts, goals, progress bars, and days left.</p>
      </section>
      <section className="section pb-24">
        <SectionHeader eyebrow="Active campaigns" title="Support the campaign closest to your heart." />
