    ...
    <section className="relative overflow-hidden pt-12 md:pt-20">
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 pb-16 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
        ...
        <motion.div initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.1 }} className="relative">
          ...
          <img className="h-[520px] w-full rounded-[2rem] object-cover shadow-glow" src="https://images.unsplash.com/photo-1503676382389-4809596d5290?auto=format&fit=crop&w=1400&q=80" alt="Children learning in a safe activity-based classroom" />
